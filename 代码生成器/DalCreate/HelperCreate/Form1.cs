...
namespace DALCreate
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Str_Text.Append("{\r\n\r\n");
            Str_Text.Append(" public class " + TableName + "Dal: BaseDal<" + TableName + ">,I" + TableName + "Dal\r\n");
            Str_Text.Append("   {\r\n\r\n");
            //Str_Text.Append("       public " + TableName + "Dal()\r\n");
            //Str_Text.Append("       {\r\n");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRowView item in CB_TableList.Items)
            {
                ...
                if (!File.Exists(Path + TableName + "Dal.cs"))
                {
                    FileInfo FilePath = new FileInfo(Path + TableName + "Dal.cs");
                ...
                StreamWriter SW = new StreamWriter(Path + TableName + "Dal.cs");
